  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        sunny: "bg-sunny text-sunny-foreground hover:bg-sunny/80",
        lavender: "bg-lavender text-lavender-foreground hover:bg-lavender/80",
        care: "bg-care text-care-foreground hover:bg-care/80",
        taken: "bg-success text-success-foreground hover:bg-success/90 shadow-soft hover:scale-105",
        missed: "bg-destructive/10 text-destructive border-2 border-destructive/30 hover:bg-destructive hover:text-destructive-foreground",
      },
      size: {
